...
#include <include/ZeeSelector.hh>
#include <map>
using namespace std;
...
int main(int argc, char* argv[]) {
  ...
  ZeeSelector sel(fileNames,"HggReduce", string(outFileName));  //sel.addTrigger("HLT_Photon26_R9Id85_OR_CaloId10_Iso50_Photon18_R9Id85_OR_CaloId10_Iso50_Mass60_v4");
  sel.setConfig(cfg);
  sel.Loop();
