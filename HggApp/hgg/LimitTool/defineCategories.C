...
CatMap getCategoryCuts(TChain* fChain){
  ...
  categories["MVA_0"] = new TTreeFormula("MVA_0"," (Mjj >= 500) && (Photon[0].pt>30. && Photon[1].pt >30.) &&  (diPhotonMVA>=-0.05)",fChain);  
  categories["MVA_1"] = new TTreeFormula("MVA_1"," (Mjj >= 250) && (Photon[0].pt>30. || Photon[1].pt >30.) &&  (diPhotonMVA>=-0.05)",fChain);  
  ...
  categories["PFCiC_0"] = new TTreeFormula("PFCiC_0","(MjjPFCiC >= 500) && (PhotonPFCiC[0].pt>30. && PhotonPFCiC[1].pt >30.)",fChain);
  categories["PFCiC_1"] = new TTreeFormula("PFCiC_1","(MjjPFCiC >= 250) && (PhotonPFCiC[0].pt>30. || PhotonPFCiC[1].pt >30.)",fChain);
  categories["PFCiC_2"] = new TTreeFormula("PFCiC_2","(PhotonPFCiC[0].r9 > 0.94 && PhotonPFCiC[1].r9 > 0.94) && (abs(PhotonPFCiC[0].eta) < 1.48 && abs(PhotonPFCiC[1].eta) < 1.48)",fChain);
  categories["PFCiC_3"] = new TTreeFormula("PFCiC_3","!(PhotonPFCiC[0].r9 > 0.94 && PhotonPFCiC[1].r9 > 0.94) && (abs(PhotonPFCiC[0].eta) < 1.48 && abs(PhotonPFCiC[1].eta) < 1.48)",fChain);
  categories["PFCiC_4"] = new TTreeFormula("PFCiC_4","(PhotonPFCiC[0].r9 > 0.94 && PhotonPFCiC[1].r9 > 0.94) && !(abs(PhotonPFCiC[0].eta) < 1.48 && abs(PhotonPFCiC[1].eta) < 1.48)",fChain);
  categories["PFCiC_5"] = new TTreeFormula("PFCiC_5","!(PhotonPFCiC[0].r9 > 0.94 && PhotonPFCiC[1].r9 > 0.94) && !(abs(PhotonPFCiC[0].eta) < 1.48 && abs(PhotonPFCiC[1].eta) < 1.48)",fChain);
  ...
  categories["CiC_0"] = new TTreeFormula("CiC_0","(MjjCiC >= 500) && (PhotonCiC[0].pt>30. && PhotonCiC[1].pt >30.)",fChain);
  categories["CiC_1"] = new TTreeFormula("CiC_1","(MjjCiC >= 250) && (PhotonCiC[0].pt>30. || PhotonCiC[1].pt >30.)",fChain);
  categories["CiC_2"] = new TTreeFormula("CiC_2","(PhotonCiC[0].r9 > 0.94 && PhotonCiC[1].r9 > 0.94) && (abs(PhotonCiC[0].eta) < 1.48 && abs(PhotonCiC[1].eta) < 1.48)",fChain);
  categories["CiC_3"] = new TTreeFormula("CiC_3","!(PhotonCiC[0].r9 > 0.94 && PhotonCiC[1].r9 > 0.94) && (abs(PhotonCiC[0].eta) < 1.48 && abs(PhotonCiC[1].eta) < 1.48)",fChain);
  categories["CiC_4"] = new TTreeFormula("CiC_4","(PhotonCiC[0].r9 > 0.94 && PhotonCiC[1].r9 > 0.94) && !(abs(PhotonCiC[0].eta) < 1.48 && abs(PhotonCiC[1].eta) < 1.48)",fChain);
  categories["CiC_5"] = new TTreeFormula("CiC_5","!(PhotonCiC[0].r9 > 0.94 && PhotonCiC[1].r9 > 0.94) && !(abs(PhotonCiC[0].eta) < 1.48 && abs(PhotonCiC[1].eta) < 1.48)",fChain);  
