...
public :
   ...
   Int_t           nEle;
   Int_t           chargeEle[10];   //[nEle]
   Float_t         energyEle[10];   //[nEle]
   Float_t         thetaEle[10];   //[nEle]
   Float_t         etaEle[10];   //[nEle]
   Float_t         phiEle[10];   //[nEle]
   Float_t         pxEle[10];   //[nEle]
   Float_t         pyEle[10];   //[nEle]
   Float_t         pzEle[10];   //[nEle]
   Float_t         vertexXEle[10];   //[nEle]
   Float_t         vertexYEle[10];   //[nEle]
   Float_t         vertexZEle[10];   //[nEle]
   Int_t           fiducialFlagsEle[10];   //[nEle]
   Int_t           recoFlagsEle[10];   //[nEle]
   Int_t           energyCorrectionsEle[10];   //[nEle]
   Int_t           superClusterIndexEle[10];   //[nEle]
   Int_t           PFsuperClusterIndexEle[10];   //[nEle]
   Int_t           trackIndexEle[10];   //[nEle]
   Int_t           gsfTrackIndexEle[10];   //[nEle]
   Float_t         convDistEle[10];   //[nEle]
   Float_t         convDcotEle[10];   //[nEle]
   Float_t         convRadiusEle[10];   //[nEle]
   Int_t           convTrackIndexEle[10];   //[nEle]
   Int_t           scPixChargeEle[10];   //[nEle]
   Bool_t          hasMatchedConversionEle[10];   //[nEle]
   Int_t           classificationEle[10];   //[nEle]
   Int_t           standardClassificationEle[10];   //[nEle]
   Float_t         fbremEle[10];   //[nEle]
   Int_t           nbremsEle[10];   //[nEle]
   Int_t           ambiguousGsfTracksSizeEle[10];   //[nEle]
   Float_t         hOverEEle[10];   //[nEle]
   Float_t         eSuperClusterOverPEle[10];   //[nEle]
   Float_t         eSeedOverPoutEle[10];   //[nEle]
   Float_t         eEleClusterOverPoutEle[10];   //[nEle]
   Float_t         deltaEtaAtVtxEle[10];   //[nEle]
   Float_t         deltaPhiAtVtxEle[10];   //[nEle]
   Float_t         deltaEtaAtCaloEle[10];   //[nEle]
   Float_t         deltaPhiAtCaloEle[10];   //[nEle]
   Float_t         deltaEtaEleClusterTrackAtCaloEle[10];   //[nEle]
   Float_t         deltaPhiEleClusterTrackAtCaloEle[10];   //[nEle]
   Float_t         dr03TkSumPtEle[10];   //[nEle]
   Float_t         dr03EcalRecHitSumEtEle[10];   //[nEle]
   Float_t         dr03HcalTowerSumEtEle[10];   //[nEle]
   Float_t         dr04TkSumPtEle[10];   //[nEle]
   Float_t         dr04EcalRecHitSumEtEle[10];   //[nEle]
   Float_t         dr04HcalTowerSumEtEle[10];   //[nEle]
   Float_t         scBasedEcalSum03Ele[10];   //[nEle]
   Float_t         scBasedEcalSum04Ele[10];   //[nEle]
   Float_t         dr03HcalTowerSumEtFullConeEle[10];   //[nEle]
   Float_t         dr04HcalTowerSumEtFullConeEle[10];   //[nEle]
   Float_t         eleIdLikelihoodEle[10];   //[nEle]
   Float_t         pflowMVAEle[10];   //[nEle]
   Float_t         pfCombinedIsoEle[10];   //[nEle]
   Float_t         pfCandChargedIso01Ele[10];   //[nEle]
   Float_t         pfCandNeutralIso01Ele[10];   //[nEle]
   Float_t         pfCandPhotonIso01Ele[10];   //[nEle]
   Float_t         pfCandChargedIso02Ele[10];   //[nEle]
   Float_t         pfCandNeutralIso02Ele[10];   //[nEle]
   Float_t         pfCandPhotonIso02Ele[10];   //[nEle]
   Float_t         pfCandChargedIso03Ele[10];   //[nEle]
   Float_t         pfCandNeutralIso03Ele[10];   //[nEle]
   Float_t         pfCandPhotonIso03Ele[10];   //[nEle]
   Float_t         pfCandChargedIso04Ele[10];   //[nEle]
   Float_t         pfCandNeutralIso04Ele[10];   //[nEle]
   Float_t         pfCandPhotonIso04Ele[10];   //[nEle]
   Float_t         pfCandChargedIso05Ele[10];   //[nEle]
   Float_t         pfCandNeutralIso05Ele[10];   //[nEle]
   Float_t         pfCandPhotonIso05Ele[10];   //[nEle]
   Float_t         pfCandChargedIso06Ele[10];   //[nEle]
   Float_t         pfCandNeutralIso06Ele[10];   //[nEle]
   Float_t         pfCandPhotonIso06Ele[10];   //[nEle]
   Float_t         pfCandChargedIso07Ele[10];   //[nEle]
   Float_t         pfCandNeutralIso07Ele[10];   //[nEle]
   Float_t         pfCandPhotonIso07Ele[10];   //[nEle]
   Float_t         pfCandChargedDirIso04Ele[10];   //[nEle]
   Float_t         pfCandNeutralDirIso04Ele[10];   //[nEle]
   Float_t         pfCandPhotonDirIso04Ele[10];   //[nEle]
   Int_t           nPho;
   Int_t           chargePho[10];   //[nPho]
   Float_t         energyPho[10];   //[nPho]
   Float_t         thetaPho[10];   //[nPho]
   Float_t         etaPho[10];   //[nPho]
   Float_t         phiPho[10];   //[nPho]
   Float_t         pxPho[10];   //[nPho]
   Float_t         pyPho[10];   //[nPho]
   Float_t         pzPho[10];   //[nPho]
   Float_t         vertexXPho[10];   //[nPho]
   Float_t         vertexYPho[10];   //[nPho]
   Float_t         vertexZPho[10];   //[nPho]
   Int_t           fiducialFlagsPho[10];   //[nPho]
   Int_t           recoFlagsPho[10];   //[nPho]
   Int_t           superClusterIndexPho[10];   //[nPho]
   Int_t           PFsuperClusterIndexPho[10];   //[nPho]
   Float_t         hOverEPho[10];   //[nPho]
   Float_t         hTowOverEPho[10];   //[nPho]
   Float_t         dr03TkSumPtPho[10];   //[nPho]
   Float_t         dr03HollowTkSumPtPho[10];   //[nPho]
   Float_t         dr03EcalRecHitSumEtPho[10];   //[nPho]
   Float_t         dr03HcalTowerSumEtPho[10];   //[nPho]
   Float_t         dr04TkSumPtPho[10];   //[nPho]
   Float_t         dr04HollowTkSumPtPho[10];   //[nPho]
   Float_t         dr04EcalRecHitSumEtPho[10];   //[nPho]
   Float_t         dr04HcalTowerSumEtPho[10];   //[nPho]
   Float_t         chargedHadronIsoPho[400];   //[nPho]
   Float_t         neutralHadronIsoPho[10];   //[nPho]
   ...
   Float_t         pzPairConv[40];   //[nConv]
   Float_t         pxRefittedPairConv[40];   //[nConv]
   Float_t         pyRefittedPairConv[40];   //[nConv]
   Float_t         pzRefittedPairConv[40];   //[nConv]
   Float_t         etaRefittedPairConv[40];   //[nConv]
   Float_t         phiRefittedPairConv[40];   //[nConv]
   Float_t         ptRefittedPairConv[40];   //[nConv]
   Float_t         energyRefittedPairConv[40];   //[nConv]
   Float_t         eOverPRefittedPairConv[40];   //[nConv]
   Float_t         zOfPVFromTracksConv[40];   //[nConv]
   Float_t         xVtxConv[40];   //[nConv]
   Float_t         yVtxConv[40];   //[nConv]
   Float_t         zVtxConv[40];   //[nConv]
   Float_t         chi2VtxConv[40];   //[nConv]
   Float_t         chi2ProbVtxConv[40];   //[nConv]
   Int_t           isValidVtxConv[40];   //[nConv]
   Int_t           nTracksVtxConv[40];   //[nConv]
   Float_t         mvaOutVtxConv[40];   //[nConv]
   Float_t         trk1DzConv[40];   //[nConv]
   Float_t         trk1DzErrorConv[40];   //[nConv]
   Float_t         trk1ChargeConv[40];   //[nConv]
   Float_t         trk1AlgoConv[40];   //[nConv]
   Float_t         trk1PtConv[40];   //[nConv]
   Float_t         trk1D0Conv[40];   //[nConv]
   Float_t         trk1PoutConv[40];   //[nConv]
   Float_t         trk1PinConv[40];   //[nConv]
   Float_t         trk2DzConv[40];   //[nConv]
   Float_t         trk2DzErrorConv[40];   //[nConv]
   Float_t         trk2ChargeConv[40];   //[nConv]
   Float_t         trk2AlgoConv[40];   //[nConv]
   Float_t         trk2PtConv[40];   //[nConv]
   Float_t         trk2D0Conv[40];   //[nConv]
   Float_t         trk2PoutConv[40];   //[nConv]
   Float_t         trk2PinConv[40];   //[nConv]
   Int_t           nSC;
   Int_t           nBCSC[250];   //[nSC]
   Int_t           nCrystalsSC[250];   //[nSC]
   Float_t         rawEnergySC[250];   //[nSC]
   Float_t         energySC[250];   //[nSC]
   Float_t         seedClusterEnergySC[250];   //[nSC]
   Float_t         esEnergySC[250];   //[nSC]
   Float_t         etaSC[250];   //[nSC]
   Float_t         thetaSC[250];   //[nSC]
   Float_t         phiSC[250];   //[nSC]
   Float_t         xPosSC[250];   //[nSC]
   Float_t         yPosSC[250];   //[nSC]
   Float_t         zPosSC[250];   //[nSC]
   Float_t         phiWidthSC[250];   //[nSC]
   Float_t         etaWidthSC[250];   //[nSC]
   Float_t         e3x3SC[250];   //[nSC]
   Float_t         e3x1SC[250];   //[nSC]
   Float_t         e1x3SC[250];   //[nSC]
   Float_t         e4x4SC[250];   //[nSC]
   Float_t         e5x5SC[250];   //[nSC]
   Float_t         eMaxSC[250];   //[nSC]
   Float_t         e2x2SC[250];   //[nSC]
   Float_t         e2ndSC[250];   //[nSC]
   Float_t         e1x5SC[250];   //[nSC]
   Float_t         e2x5MaxSC[250];   //[nSC]
   Float_t         e2x5LeftSC[250];   //[nSC]
   Float_t         e2x5RightSC[250];   //[nSC]
   Float_t         e2x5TopSC[250];   //[nSC]
   Float_t         e2x5BottomSC[250];   //[nSC]
   Float_t         eLeftSC[250];   //[nSC]
   Float_t         eRightSC[250];   //[nSC]
   Float_t         eTopSC[250];   //[nSC]
   Float_t         eBottomSC[250];   //[nSC]
   Float_t         e4SwissCrossSC[250];   //[nSC]
   Float_t         covIEtaIEtaSC[250];   //[nSC]
   Float_t         covIEtaIPhiSC[250];   //[nSC]
   Float_t         covIPhiIPhiSC[250];   //[nSC]
   Float_t         sMajSC[250];   //[nSC]
   Float_t         sMinSC[250];   //[nSC]
   Float_t         alphaSC[250];   //[nSC]
   Float_t         hOverESC[250];   //[nSC]
   Int_t           recoFlagSC[250];   //[nSC]
   Float_t         timeSC[250];   //[nSC]
   Float_t         chi2SC[250];   //[nSC]
   Float_t         seedEnergySC[250];   //[nSC]
   Float_t         seedXSC[250];   //[nSC]
   Float_t         seedYSC[250];   //[nSC]
   Float_t         esEffsIxIxSC[250];   //[nSC]
   Float_t         esEffsIyIySC[250];   //[nSC]
   Float_t         esL1EnergySC[250];   //[nSC]
   Float_t         esL2EnergySC[250];   //[nSC]
   Int_t           esL1StripsSC[250];   //[nSC]
   Int_t           esL2StripsSC[250];   //[nSC]
   Int_t           nPFSC;
   ...
   Int_t           nPhoPFSC;
   Int_t           nBCPhoPFSC[10];   //[nPhoPFSC]
   Int_t           nCrystalsPhoPFSC[10];   //[nPhoPFSC]
   Float_t         rawEnergyPhoPFSC[10];   //[nPhoPFSC]
   Float_t         energyPhoPFSC[10];   //[nPhoPFSC]
   Float_t         seedClusterEnergyPhoPFSC[10];   //[nPhoPFSC]
   ...
   Int_t           nPV;
   Float_t         PVxPV[80];   //[nPV]
   Float_t         PVyPV[80];   //[nPV]
   Float_t         PVzPV[80];   //[nPV]
   Float_t         PVErrxPV[80];   //[nPV]
   Float_t         PVErryPV[80];   //[nPV]
   Float_t         PVErrzPV[80];   //[nPV]
   Float_t         SumPtPV[80];   //[nPV]
   Float_t         rhoPV[80];   //[nPV]
   Float_t         ndofPV[80];   //[nPV]
   Float_t         chi2PV[80];   //[nPV]
   Float_t         normChi2PV[80];   //[nPV]
   Float_t         pxChMetPV[80];   //[nPV]
   Float_t         pyChMetPV[80];   //[nPV]
   Float_t         pzChMetPV[80];   //[nPV]
   Int_t           isFakePV[80];   //[nPV]
   Int_t           isValidPV[80];   //[nPV]
   Int_t           trackSizePV[80];   //[nPV]
   Int_t           nMuon;
   ...
   Int_t           typeMuon[20];   //[nMuon]
   Int_t           numberOfMatchesMuon[20];   //[nMuon]
   ...
   Float_t         pfCombinedIsoMuon[20];   //[nMuon]
   Float_t         pfCandChargedIso01Muon[20];   //[nMuon]
   Float_t         pfCandNeutralIso01Muon[20];   //[nMuon]
   Float_t         pfCandPhotonIso01Muon[20];   //[nMuon]
   Float_t         pfCandChargedIso02Muon[20];   //[nMuon]
   Float_t         pfCandNeutralIso02Muon[20];   //[nMuon]
   Float_t         pfCandPhotonIso02Muon[20];   //[nMuon]
   Float_t         pfCandChargedIso03Muon[20];   //[nMuon]
   Float_t         pfCandNeutralIso03Muon[20];   //[nMuon]
   Float_t         pfCandPhotonIso03Muon[20];   //[nMuon]
   Float_t         pfCandChargedIso04Muon[20];   //[nMuon]
   Float_t         pfCandNeutralIso04Muon[20];   //[nMuon]
   Float_t         pfCandPhotonIso04Muon[20];   //[nMuon]
   Float_t         pfCandChargedIso05Muon[20];   //[nMuon]
   Float_t         pfCandNeutralIso05Muon[20];   //[nMuon]
   Float_t         pfCandPhotonIso05Muon[20];   //[nMuon]
   Float_t         pfCandChargedIso06Muon[20];   //[nMuon]
   Float_t         pfCandNeutralIso06Muon[20];   //[nMuon]
   Float_t         pfCandPhotonIso06Muon[20];   //[nMuon]
   Float_t         pfCandChargedIso07Muon[20];   //[nMuon]
   Float_t         pfCandNeutralIso07Muon[20];   //[nMuon]
   Float_t         pfCandPhotonIso07Muon[20];   //[nMuon]
   Float_t         pfCandChargedDirIso04Muon[20];   //[nMuon]
   Float_t         pfCandNeutralDirIso04Muon[20];   //[nMuon]
   Float_t         pfCandPhotonDirIso04Muon[20];   //[nMuon]
   Float_t         kinkMuon[20];   //[nMuon]
