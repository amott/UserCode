...
public :
   ...
   Int_t           nHLT;
   Int_t           indexHLT[453];   //[nHLT]
   vector<string>  *nameHLT;
   Int_t           nTriggerPaths;
   Int_t           nTriggerObsPassing;
   Int_t           sizePassing[453];   //[nTriggerPaths]
   Int_t           indexPassing[345];   //[nTriggerObsPassing]
   Int_t           indexPassingPerPath[453];   //[nTriggerPaths]
   Int_t           nTriggerObs;
   Float_t         triggerObsPt[881];   //[nTriggerObs]
   Float_t         triggerObsPhi[881];   //[nTriggerObs]
   Float_t         triggerObsEta[881];   //[nTriggerObs]
   Float_t         triggerObsMass[881];   //[nTriggerObs]
   Int_t           nEle;
   ...
   Int_t           fiducialFlagsEle[3];   //[nEle]
   Int_t           recoFlagsEle[3];   //[nEle]
   Int_t           energyCorrectionsEle[3];   //[nEle]
   Int_t           superClusterIndexEle[3];   //[nEle]
   Int_t           PFsuperClusterIndexEle[3];   //[nEle]
   Int_t           trackIndexEle[3];   //[nEle]
   Int_t           gsfTrackIndexEle[3];   //[nEle]
   Float_t         convDistEle[3];   //[nEle]
   Float_t         convDcotEle[3];   //[nEle]
   Float_t         convRadiusEle[3];   //[nEle]
   Int_t           convTrackIndexEle[3];   //[nEle]
   Int_t           scPixChargeEle[3];   //[nEle]
   Bool_t          hasMatchedConversionEle[3];   //[nEle]
   Int_t           classificationEle[3];   //[nEle]
   Int_t           standardClassificationEle[3];   //[nEle]
   Float_t         fbremEle[3];   //[nEle]
   Int_t           nbremsEle[3];   //[nEle]
   Int_t           ambiguousGsfTracksSizeEle[3];   //[nEle]
   Float_t         hOverEEle[3];   //[nEle]
   Float_t         eSuperClusterOverPEle[3];   //[nEle]
   Float_t         eSeedOverPoutEle[3];   //[nEle]
   Float_t         eEleClusterOverPoutEle[3];   //[nEle]
   Float_t         deltaEtaAtVtxEle[3];   //[nEle]
   Float_t         deltaPhiAtVtxEle[3];   //[nEle]
   Float_t         deltaEtaAtCaloEle[3];   //[nEle]
   Float_t         deltaPhiAtCaloEle[3];   //[nEle]
   Float_t         deltaEtaEleClusterTrackAtCaloEle[3];   //[nEle]
   Float_t         deltaPhiEleClusterTrackAtCaloEle[3];   //[nEle]
   Float_t         dr03TkSumPtEle[3];   //[nEle]
   Float_t         dr03EcalRecHitSumEtEle[3];   //[nEle]
   Float_t         dr03HcalTowerSumEtEle[3];   //[nEle]
   Float_t         dr04TkSumPtEle[3];   //[nEle]
   Float_t         dr04EcalRecHitSumEtEle[3];   //[nEle]
   Float_t         dr04HcalTowerSumEtEle[3];   //[nEle]
   Float_t         scBasedEcalSum03Ele[3];   //[nEle]
   Float_t         scBasedEcalSum04Ele[3];   //[nEle]
   Float_t         dr03HcalTowerSumEtFullConeEle[3];   //[nEle]
   Float_t         dr04HcalTowerSumEtFullConeEle[3];   //[nEle]
   Float_t         eleIdLikelihoodEle[3];   //[nEle]
   Float_t         pflowMVAEle[3];   //[nEle]
   Float_t         pfCombinedIsoEle[3];   //[nEle]
   Float_t         pfCandChargedIso01Ele[3];   //[nEle]
   Float_t         pfCandNeutralIso01Ele[3];   //[nEle]
   Float_t         pfCandPhotonIso01Ele[3];   //[nEle]
   Float_t         pfCandChargedIso02Ele[3];   //[nEle]
   Float_t         pfCandNeutralIso02Ele[3];   //[nEle]
   Float_t         pfCandPhotonIso02Ele[3];   //[nEle]
   Float_t         pfCandChargedIso03Ele[3];   //[nEle]
   Float_t         pfCandNeutralIso03Ele[3];   //[nEle]
   Float_t         pfCandPhotonIso03Ele[3];   //[nEle]
   Float_t         pfCandChargedIso04Ele[3];   //[nEle]
   Float_t         pfCandNeutralIso04Ele[3];   //[nEle]
   Float_t         pfCandPhotonIso04Ele[3];   //[nEle]
   Float_t         pfCandChargedIso05Ele[3];   //[nEle]
   Float_t         pfCandNeutralIso05Ele[3];   //[nEle]
   Float_t         pfCandPhotonIso05Ele[3];   //[nEle]
   Float_t         pfCandChargedIso06Ele[3];   //[nEle]
   Float_t         pfCandNeutralIso06Ele[3];   //[nEle]
   Float_t         pfCandPhotonIso06Ele[3];   //[nEle]
   Float_t         pfCandChargedIso07Ele[3];   //[nEle]
   Float_t         pfCandNeutralIso07Ele[3];   //[nEle]
   Float_t         pfCandPhotonIso07Ele[3];   //[nEle]
   Float_t         pfCandChargedDirIso04Ele[3];   //[nEle]
   Float_t         pfCandNeutralDirIso04Ele[3];   //[nEle]
   Float_t         pfCandPhotonDirIso04Ele[3];   //[nEle]
   Int_t           nPho;
   Int_t           chargePho[5];   //[nPho]
   Float_t         energyPho[5];   //[nPho]
   Float_t         thetaPho[5];   //[nPho]
   Float_t         etaPho[5];   //[nPho]
   Float_t         phiPho[5];   //[nPho]
   Float_t         pxPho[5];   //[nPho]
   Float_t         pyPho[5];   //[nPho]
   Float_t         pzPho[5];   //[nPho]
   Float_t         vertexXPho[5];   //[nPho]
   Float_t         vertexYPho[5];   //[nPho]
   Float_t         vertexZPho[5];   //[nPho]
   Int_t           fiducialFlagsPho[5];   //[nPho]
   Int_t           recoFlagsPho[5];   //[nPho]
   ...
   Float_t         dr03HcalTowerSumEtPho[5];   //[nPho]
   Float_t         dr04TkSumPtPho[5];   //[nPho]
   Float_t         dr04HollowTkSumPtPho[5];   //[nPho]
   Float_t         dr04EcalRecHitSumEtPho[5];   //[nPho]
   Float_t         dr04HcalTowerSumEtPho[5];   //[nPho]
   Float_t         chargedHadronIsoPho[5];   //[nPho]
   Float_t         neutralHadronIsoPho[5];   //[nPho]
   Float_t         photonIsoPho[5];   //[nPho]
   Int_t           hasPixelSeedPho[5];   //[nPho]
   Bool_t          hasMatchedConversionPho[5];   //[nPho]
   Int_t           nConv;
   ...
   Int_t           nSC;
   Int_t           nBCSC[102];   //[nSC]
   Int_t           nCrystalsSC[102];   //[nSC]
   Float_t         rawEnergySC[102];   //[nSC]
   Float_t         energySC[102];   //[nSC]
   Float_t         seedClusterEnergySC[102];   //[nSC]
   Float_t         esEnergySC[102];   //[nSC]
   Float_t         etaSC[102];   //[nSC]
   Float_t         thetaSC[102];   //[nSC]
   Float_t         phiSC[102];   //[nSC]
   Float_t         xPosSC[102];   //[nSC]
   Float_t         yPosSC[102];   //[nSC]
   Float_t         zPosSC[102];   //[nSC]
   Float_t         phiWidthSC[102];   //[nSC]
   Float_t         etaWidthSC[102];   //[nSC]
   Float_t         e3x3SC[102];   //[nSC]
   Float_t         e3x1SC[102];   //[nSC]
   Float_t         e1x3SC[102];   //[nSC]
   Float_t         e4x4SC[102];   //[nSC]
   Float_t         e5x5SC[102];   //[nSC]
   Float_t         eMaxSC[102];   //[nSC]
   Float_t         e2x2SC[102];   //[nSC]
   Float_t         e2ndSC[102];   //[nSC]
   Float_t         e1x5SC[102];   //[nSC]
   Float_t         e2x5MaxSC[102];   //[nSC]
   Float_t         e2x5LeftSC[102];   //[nSC]
   Float_t         e2x5RightSC[102];   //[nSC]
   Float_t         e2x5TopSC[102];   //[nSC]
   Float_t         e2x5BottomSC[102];   //[nSC]
   Float_t         eLeftSC[102];   //[nSC]
   Float_t         eRightSC[102];   //[nSC]
   Float_t         eTopSC[102];   //[nSC]
   Float_t         eBottomSC[102];   //[nSC]
   Float_t         e4SwissCrossSC[102];   //[nSC]
   Float_t         covIEtaIEtaSC[102];   //[nSC]
   Float_t         covIEtaIPhiSC[102];   //[nSC]
   Float_t         covIPhiIPhiSC[102];   //[nSC]
   Float_t         sMajSC[102];   //[nSC]
   Float_t         sMinSC[102];   //[nSC]
   Float_t         alphaSC[102];   //[nSC]
   Float_t         hOverESC[102];   //[nSC]
   Int_t           recoFlagSC[102];   //[nSC]
   Float_t         timeSC[102];   //[nSC]
   Float_t         chi2SC[102];   //[nSC]
   Float_t         seedEnergySC[102];   //[nSC]
   Float_t         seedXSC[102];   //[nSC]
   Float_t         seedYSC[102];   //[nSC]
   Float_t         esEffsIxIxSC[102];   //[nSC]
   Float_t         esEffsIyIySC[102];   //[nSC]
   Float_t         esL1EnergySC[102];   //[nSC]
   Float_t         esL2EnergySC[102];   //[nSC]
   Int_t           esL1StripsSC[102];   //[nSC]
   Int_t           esL2StripsSC[102];   //[nSC]
   Int_t           nPFSC;
   Int_t           nBCPFSC[2];   //[nPFSC]
   Int_t           nCrystalsPFSC[2];   //[nPFSC]
   Float_t         rawEnergyPFSC[2];   //[nPFSC]
   Float_t         energyPFSC[2];   //[nPFSC]
   Float_t         seedClusterEnergyPFSC[2];   //[nPFSC]
   Float_t         esEnergyPFSC[2];   //[nPFSC]
   Float_t         etaPFSC[2];   //[nPFSC]
   Float_t         thetaPFSC[2];   //[nPFSC]
   Float_t         phiPFSC[2];   //[nPFSC]
   Float_t         xPosPFSC[2];   //[nPFSC]
   Float_t         yPosPFSC[2];   //[nPFSC]
   Float_t         zPosPFSC[2];   //[nPFSC]
   Float_t         phiWidthPFSC[2];   //[nPFSC]
   Float_t         etaWidthPFSC[2];   //[nPFSC]
   Float_t         e3x3PFSC[2];   //[nPFSC]
   Float_t         e3x1PFSC[2];   //[nPFSC]
   Float_t         e1x3PFSC[2];   //[nPFSC]
   Float_t         e4x4PFSC[2];   //[nPFSC]
   Float_t         e5x5PFSC[2];   //[nPFSC]
   Float_t         eMaxPFSC[2];   //[nPFSC]
   Float_t         e2x2PFSC[2];   //[nPFSC]
   Float_t         e2ndPFSC[2];   //[nPFSC]
   Float_t         e1x5PFSC[2];   //[nPFSC]
   Float_t         e2x5MaxPFSC[2];   //[nPFSC]
   Float_t         e2x5LeftPFSC[2];   //[nPFSC]
   Float_t         e2x5RightPFSC[2];   //[nPFSC]
   Float_t         e2x5TopPFSC[2];   //[nPFSC]
   Float_t         e2x5BottomPFSC[2];   //[nPFSC]
   Float_t         eLeftPFSC[2];   //[nPFSC]
   Float_t         eRightPFSC[2];   //[nPFSC]
   Float_t         eTopPFSC[2];   //[nPFSC]
   Float_t         eBottomPFSC[2];   //[nPFSC]
   Float_t         e4SwissCrossPFSC[2];   //[nPFSC]
   Float_t         covIEtaIEtaPFSC[2];   //[nPFSC]
   Float_t         covIEtaIPhiPFSC[2];   //[nPFSC]
   Float_t         covIPhiIPhiPFSC[2];   //[nPFSC]
   Float_t         sMajPFSC[2];   //[nPFSC]
   Float_t         sMinPFSC[2];   //[nPFSC]
   Float_t         alphaPFSC[2];   //[nPFSC]
   Float_t         hOverEPFSC[2];   //[nPFSC]
   Int_t           recoFlagPFSC[2];   //[nPFSC]
   Float_t         timePFSC[2];   //[nPFSC]
   Float_t         chi2PFSC[2];   //[nPFSC]
   Float_t         seedEnergyPFSC[2];   //[nPFSC]
   Float_t         seedXPFSC[2];   //[nPFSC]
   Float_t         seedYPFSC[2];   //[nPFSC]
   Float_t         esEffsIxIxPFSC[2];   //[nPFSC]
   Float_t         esEffsIyIyPFSC[2];   //[nPFSC]
   Float_t         esL1EnergyPFSC[2];   //[nPFSC]
   Float_t         esL2EnergyPFSC[2];   //[nPFSC]
   Int_t           esL1StripsPFSC[2];   //[nPFSC]
   Int_t           esL2StripsPFSC[2];   //[nPFSC]
   Int_t           nPhoPFSC;
   Int_t           nBCPhoPFSC[3];   //[nPhoPFSC]
   Int_t           nCrystalsPhoPFSC[3];   //[nPhoPFSC]
   Float_t         rawEnergyPhoPFSC[3];   //[nPhoPFSC]
   Float_t         energyPhoPFSC[3];   //[nPhoPFSC]
   Float_t         seedClusterEnergyPhoPFSC[3];   //[nPhoPFSC]
   Float_t         esEnergyPhoPFSC[3];   //[nPhoPFSC]
   Float_t         etaPhoPFSC[3];   //[nPhoPFSC]
   Float_t         thetaPhoPFSC[3];   //[nPhoPFSC]
   Float_t         phiPhoPFSC[3];   //[nPhoPFSC]
   Float_t         xPosPhoPFSC[3];   //[nPhoPFSC]
   Float_t         yPosPhoPFSC[3];   //[nPhoPFSC]
   Float_t         zPosPhoPFSC[3];   //[nPhoPFSC]
   Float_t         phiWidthPhoPFSC[3];   //[nPhoPFSC]
   Float_t         etaWidthPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e3x3PhoPFSC[3];   //[nPhoPFSC]
   Float_t         e3x1PhoPFSC[3];   //[nPhoPFSC]
   Float_t         e1x3PhoPFSC[3];   //[nPhoPFSC]
   Float_t         e4x4PhoPFSC[3];   //[nPhoPFSC]
   Float_t         e5x5PhoPFSC[3];   //[nPhoPFSC]
   Float_t         eMaxPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e2x2PhoPFSC[3];   //[nPhoPFSC]
   Float_t         e2ndPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e1x5PhoPFSC[3];   //[nPhoPFSC]
   Float_t         e2x5MaxPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e2x5LeftPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e2x5RightPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e2x5TopPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e2x5BottomPhoPFSC[3];   //[nPhoPFSC]
   Float_t         eLeftPhoPFSC[3];   //[nPhoPFSC]
   Float_t         eRightPhoPFSC[3];   //[nPhoPFSC]
   Float_t         eTopPhoPFSC[3];   //[nPhoPFSC]
   Float_t         eBottomPhoPFSC[3];   //[nPhoPFSC]
   Float_t         e4SwissCrossPhoPFSC[3];   //[nPhoPFSC]
   Float_t         covIEtaIEtaPhoPFSC[3];   //[nPhoPFSC]
   Float_t         covIEtaIPhiPhoPFSC[3];   //[nPhoPFSC]
   Float_t         covIPhiIPhiPhoPFSC[3];   //[nPhoPFSC]
   Float_t         sMajPhoPFSC[3];   //[nPhoPFSC]
   Float_t         sMinPhoPFSC[3];   //[nPhoPFSC]
   Float_t         alphaPhoPFSC[3];   //[nPhoPFSC]
   Float_t         hOverEPhoPFSC[3];   //[nPhoPFSC]
   Int_t           recoFlagPhoPFSC[3];   //[nPhoPFSC]
   Float_t         timePhoPFSC[3];   //[nPhoPFSC]
   Float_t         chi2PhoPFSC[3];   //[nPhoPFSC]
   Float_t         seedEnergyPhoPFSC[3];   //[nPhoPFSC]
   Float_t         seedXPhoPFSC[3];   //[nPhoPFSC]
   Float_t         seedYPhoPFSC[3];   //[nPhoPFSC]
   Float_t         esEffsIxIxPhoPFSC[3];   //[nPhoPFSC]
   Float_t         esEffsIyIyPhoPFSC[3];   //[nPhoPFSC]
   Float_t         esL1EnergyPhoPFSC[3];   //[nPhoPFSC]
   Float_t         esL2EnergyPhoPFSC[3];   //[nPhoPFSC]
   Int_t           esL1StripsPhoPFSC[3];   //[nPhoPFSC]
   Int_t           esL2StripsPhoPFSC[3];   //[nPhoPFSC]
   Int_t           nBC;
   Int_t           nCrystalsBC[291];   //[nBC]
   Float_t         energyBC[291];   //[nBC]
   Float_t         etaBC[291];   //[nBC]
   Float_t         thetaBC[291];   //[nBC]
   Float_t         phiBC[291];   //[nBC]
   Float_t         e3x3BC[291];   //[nBC]
   Float_t         e5x5BC[291];   //[nBC]
   Float_t         eMaxBC[291];   //[nBC]
   Float_t         e2x2BC[291];   //[nBC]
   Float_t         e2ndBC[291];   //[nBC]
   Float_t         eTopBC[291];   //[nBC]
   ...
   Int_t           iPhiBC[291];   //[nBC]
   Float_t         thetaTiltBC[291];   //[nBC]
   Float_t         phiTiltBC[291];   //[nBC]
   Float_t         covIEtaIEtaBC[291];   //[nBC]
   Float_t         covIEtaIPhiBC[291];   //[nBC]
   Float_t         covIPhiIPhiBC[291];   //[nBC]
   Int_t           recoFlagBC[291];   //[nBC]
   Float_t         timeBC[291];   //[nBC]
   Float_t         chi2BC[291];   //[nBC]
   Float_t         seedEnergyBC[291];   //[nBC]
   Int_t           idClosProblBC[291];   //[nBC]
   Int_t           sevClosProblBC[291];   //[nBC]
   Float_t         fracClosProblBC[291];   //[nBC]
   Int_t           indexSCBC[291];   //[nBC]
   Int_t           nPFBC;
   Int_t           nCrystalsPFBC[11];   //[nPFBC]
   Float_t         energyPFBC[11];   //[nPFBC]
   Float_t         etaPFBC[11];   //[nPFBC]
   Float_t         thetaPFBC[11];   //[nPFBC]
   Float_t         phiPFBC[11];   //[nPFBC]
   Float_t         e3x3PFBC[11];   //[nPFBC]
   Float_t         e5x5PFBC[11];   //[nPFBC]
   Float_t         eMaxPFBC[11];   //[nPFBC]
   Float_t         e2x2PFBC[11];   //[nPFBC]
   Float_t         e2ndPFBC[11];   //[nPFBC]
   Float_t         eTopPFBC[11];   //[nPFBC]
   ...
   Int_t           iPhiPFBC[11];   //[nPFBC]
   Float_t         thetaTiltPFBC[11];   //[nPFBC]
   Float_t         phiTiltPFBC[11];   //[nPFBC]
   Float_t         covIEtaIEtaPFBC[11];   //[nPFBC]
   Float_t         covIEtaIPhiPFBC[11];   //[nPFBC]
   Float_t         covIPhiIPhiPFBC[11];   //[nPFBC]
   Int_t           recoFlagPFBC[11];   //[nPFBC]
   Float_t         timePFBC[11];   //[nPFBC]
   Float_t         chi2PFBC[11];   //[nPFBC]
   Float_t         seedEnergyPFBC[11];   //[nPFBC]
   Int_t           idClosProblPFBC[11];   //[nPFBC]
   Int_t           sevClosProblPFBC[11];   //[nPFBC]
   Float_t         fracClosProblPFBC[11];   //[nPFBC]
   Int_t           indexSCPFBC[11];   //[nPFBC]
   Int_t           nTrack;
   Float_t         pxTrack[685];   //[nTrack]
   Float_t         pyTrack[685];   //[nTrack]
   Float_t         pzTrack[685];   //[nTrack]
   Int_t           vtxIndexTrack[685];   //[nTrack]
   Float_t         vtxWeightTrack[685];   //[nTrack]
   Float_t         impactPar3DTrack[685];   //[nTrack]
   Float_t         impactPar3DErrorTrack[685];   //[nTrack]
   Float_t         transvImpactParTrack[685];   //[nTrack]
   Float_t         transvImpactParErrorTrack[685];   //[nTrack]
   Float_t         impactPar3DBiasedTrack[685];   //[nTrack]
   Float_t         impactPar3DBiasedErrorTrack[685];   //[nTrack]
   Float_t         transvImpactParBiasedTrack[685];   //[nTrack]
   Float_t         transvImpactParBiasedErrorTrack[685];   //[nTrack]
   Float_t         chargeTrack[685];   //[nTrack]
   Float_t         ptErrorTrack[685];   //[nTrack]
   Float_t         trackValidHitsTrack[685];   //[nTrack]
   Float_t         trackLostHitsTrack[685];   //[nTrack]
   Float_t         trackNormalizedChi2Track[685];   //[nTrack]
   Int_t           qualityMaskTrack[685];   //[nTrack]
   Float_t         trackVxTrack[685];   //[nTrack]
   Float_t         trackVyTrack[685];   //[nTrack]
   Float_t         trackVzTrack[685];   //[nTrack]
   Float_t         d0Track[685];   //[nTrack]
   Float_t         d0ErrorTrack[685];   //[nTrack]
   Float_t         dzTrack[685];   //[nTrack]
   Float_t         dzErrorTrack[685];   //[nTrack]
   Int_t           pixelHitsTrack[685];   //[nTrack]
   Int_t           trackerLayersWithMeasurementTrack[685];   //[nTrack]
   Int_t           expInnerLayersTrack[685];   //[nTrack]
   Int_t           numberOfValidPixelBarrelHitsTrack[685];   //[nTrack]
   Int_t           numberOfValidPixelEndcapHitsTrack[685];   //[nTrack]
   Int_t           numberOfValidStripTIBHitsTrack[685];   //[nTrack]
   Int_t           numberOfValidStripTIDHitsTrack[685];   //[nTrack]
   Int_t           numberOfValidStripTOBHitsTrack[685];   //[nTrack]
   Int_t           numberOfValidStripTECHitsTrack[685];   //[nTrack]
   Int_t           numberOfValidMuonHitsTrack[685];   //[nTrack]
   Int_t           nGsfTrack;
   Float_t         pxGsfTrack[13];   //[nGsfTrack]
   Float_t         pyGsfTrack[13];   //[nGsfTrack]
   Float_t         pzGsfTrack[13];   //[nGsfTrack]
   Int_t           vtxIndexGsfTrack[13];   //[nGsfTrack]
   Float_t         vtxWeightGsfTrack[13];   //[nGsfTrack]
   Float_t         impactPar3DGsfTrack[13];   //[nGsfTrack]
   Float_t         impactPar3DErrorGsfTrack[13];   //[nGsfTrack]
   Float_t         transvImpactParGsfTrack[13];   //[nGsfTrack]
   Float_t         transvImpactParErrorGsfTrack[13];   //[nGsfTrack]
   Float_t         impactPar3DBiasedGsfTrack[13];   //[nGsfTrack]
   Float_t         impactPar3DBiasedErrorGsfTrack[13];   //[nGsfTrack]
   Float_t         transvImpactParBiasedGsfTrack[13];   //[nGsfTrack]
   Float_t         transvImpactParBiasedErrorGsfTrack[13];   //[nGsfTrack]
   Float_t         chargeGsfTrack[13];   //[nGsfTrack]
   Float_t         ptErrorGsfTrack[13];   //[nGsfTrack]
   Float_t         trackValidHitsGsfTrack[13];   //[nGsfTrack]
   Float_t         trackLostHitsGsfTrack[13];   //[nGsfTrack]
   Float_t         trackNormalizedChi2GsfTrack[13];   //[nGsfTrack]
   Int_t           qualityMaskGsfTrack[13];   //[nGsfTrack]
   Float_t         trackVxGsfTrack[13];   //[nGsfTrack]
   Float_t         trackVyGsfTrack[13];   //[nGsfTrack]
   Float_t         trackVzGsfTrack[13];   //[nGsfTrack]
   Float_t         d0GsfTrack[13];   //[nGsfTrack]
   Float_t         d0ErrorGsfTrack[13];   //[nGsfTrack]
   Float_t         dzGsfTrack[13];   //[nGsfTrack]
   Float_t         dzErrorGsfTrack[13];   //[nGsfTrack]
   Int_t           pixelHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           trackerLayersWithMeasurementGsfTrack[13];   //[nGsfTrack]
   Int_t           expInnerLayersGsfTrack[13];   //[nGsfTrack]
   Int_t           numberOfValidPixelBarrelHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           numberOfValidPixelEndcapHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           numberOfValidStripTIBHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           numberOfValidStripTIDHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           numberOfValidStripTOBHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           numberOfValidStripTECHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           numberOfValidMuonHitsGsfTrack[13];   //[nGsfTrack]
   Int_t           chargeModeGsfTrack[13];   //[nGsfTrack]
   Float_t         pxModeGsfTrack[13];   //[nGsfTrack]
   Float_t         pyModeGsfTrack[13];   //[nGsfTrack]
   Float_t         pzModeGsfTrack[13];   //[nGsfTrack]
   Int_t           nGlobalMuonTrack;
   Float_t         pxGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         pyGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         pzGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           vtxIndexGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         vtxWeightGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         impactPar3DGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         impactPar3DErrorGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         transvImpactParGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         transvImpactParErrorGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         impactPar3DBiasedGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         impactPar3DBiasedErrorGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         transvImpactParBiasedGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         transvImpactParBiasedErrorGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         chargeGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         ptErrorGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         trackValidHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         trackLostHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         trackNormalizedChi2GlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           qualityMaskGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         trackVxGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         trackVyGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         trackVzGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         d0GlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         d0ErrorGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         dzGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Float_t         dzErrorGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           pixelHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           trackerLayersWithMeasurementGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           expInnerLayersGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIBHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTIDHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTOBHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           numberOfValidStripTECHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           numberOfValidMuonHitsGlobalMuonTrack[1];   //[nGlobalMuonTrack]
   Int_t           nSTAMuonTrack;
   Float_t         pxSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         pySTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         pzSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         chargeSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         ptErrorSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         trackValidHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         trackLostHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         trackNormalizedChi2STAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           qualityMaskSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         trackVxSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         trackVySTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         trackVzSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         d0STAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         d0ErrorSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         dzSTAMuonTrack[1];   //[nSTAMuonTrack]
   Float_t         dzErrorSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           pixelHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           trackerLayersWithMeasurementSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           expInnerLayersSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelBarrelHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           numberOfValidPixelEndcapHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIBHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTIDHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTOBHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           numberOfValidStripTECHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           numberOfValidMuonHitsSTAMuonTrack[1];   //[nSTAMuonTrack]
   Int_t           nPV;
   Float_t         PVxPV[43];   //[nPV]
   Float_t         PVyPV[43];   //[nPV]
   Float_t         PVzPV[43];   //[nPV]
   Float_t         PVErrxPV[43];   //[nPV]
   Float_t         PVErryPV[43];   //[nPV]
   Float_t         PVErrzPV[43];   //[nPV]
   Float_t         SumPtPV[43];   //[nPV]
   Float_t         rhoPV[43];   //[nPV]
   Float_t         ndofPV[43];   //[nPV]
   Float_t         chi2PV[43];   //[nPV]
   Float_t         normChi2PV[43];   //[nPV]
   Float_t         pxChMetPV[43];   //[nPV]
   Float_t         pyChMetPV[43];   //[nPV]
   Float_t         pzChMetPV[43];   //[nPV]
   Int_t           isFakePV[43];   //[nPV]
   Int_t           isValidPV[43];   //[nPV]
   Int_t           trackSizePV[43];   //[nPV]
   Int_t           nMuon;
   Int_t           chargeMuon[9];   //[nMuon]
   Float_t         energyMuon[9];   //[nMuon]
   Float_t         thetaMuon[9];   //[nMuon]
   Float_t         etaMuon[9];   //[nMuon]
   Float_t         phiMuon[9];   //[nMuon]
   Float_t         pxMuon[9];   //[nMuon]
   Float_t         pyMuon[9];   //[nMuon]
   Float_t         pzMuon[9];   //[nMuon]
   Float_t         vertexXMuon[9];   //[nMuon]
   Float_t         vertexYMuon[9];   //[nMuon]
   Float_t         vertexZMuon[9];   //[nMuon]
   Int_t           trackIndexMuon[9];   //[nMuon]
   Int_t           standAloneTrackIndexMuon[9];   //[nMuon]
   Int_t           combinedTrackIndexMuon[9];   //[nMuon]
   Int_t           muonIdMuon[9];   //[nMuon]
   Int_t           typeMuon[9];   //[nMuon]
   Int_t           numberOfMatchesMuon[9];   //[nMuon]
   Float_t         sumPt03Muon[9];   //[nMuon]
   Float_t         emEt03Muon[9];   //[nMuon]
   Float_t         hadEt03Muon[9];   //[nMuon]
   Float_t         hoEt03Muon[9];   //[nMuon]
   Float_t         nTrk03Muon[9];   //[nMuon]
   Float_t         nJets03Muon[9];   //[nMuon]
   Float_t         sumPt05Muon[9];   //[nMuon]
   Float_t         emEt05Muon[9];   //[nMuon]
   Float_t         hadEt05Muon[9];   //[nMuon]
   Float_t         hoEt05Muon[9];   //[nMuon]
   Float_t         nTrk05Muon[9];   //[nMuon]
   Float_t         nJets05Muon[9];   //[nMuon]
   Float_t         pfCombinedIsoMuon[9];   //[nMuon]
   Float_t         pfCandChargedIso01Muon[9];   //[nMuon]
   Float_t         pfCandNeutralIso01Muon[9];   //[nMuon]
   Float_t         pfCandPhotonIso01Muon[9];   //[nMuon]
   Float_t         pfCandChargedIso02Muon[9];   //[nMuon]
   Float_t         pfCandNeutralIso02Muon[9];   //[nMuon]
   Float_t         pfCandPhotonIso02Muon[9];   //[nMuon]
   Float_t         pfCandChargedIso03Muon[9];   //[nMuon]
   Float_t         pfCandNeutralIso03Muon[9];   //[nMuon]
   Float_t         pfCandPhotonIso03Muon[9];   //[nMuon]
   Float_t         pfCandChargedIso04Muon[9];   //[nMuon]
   Float_t         pfCandNeutralIso04Muon[9];   //[nMuon]
   Float_t         pfCandPhotonIso04Muon[9];   //[nMuon]
   Float_t         pfCandChargedIso05Muon[9];   //[nMuon]
   Float_t         pfCandNeutralIso05Muon[9];   //[nMuon]
   Float_t         pfCandPhotonIso05Muon[9];   //[nMuon]
   Float_t         pfCandChargedIso06Muon[9];   //[nMuon]
   Float_t         pfCandNeutralIso06Muon[9];   //[nMuon]
   Float_t         pfCandPhotonIso06Muon[9];   //[nMuon]
   Float_t         pfCandChargedIso07Muon[9];   //[nMuon]
   Float_t         pfCandNeutralIso07Muon[9];   //[nMuon]
   Float_t         pfCandPhotonIso07Muon[9];   //[nMuon]
   Float_t         pfCandChargedDirIso04Muon[9];   //[nMuon]
   Float_t         pfCandNeutralDirIso04Muon[9];   //[nMuon]
   Float_t         pfCandPhotonDirIso04Muon[9];   //[nMuon]
   Float_t         kinkMuon[9];   //[nMuon]
   Float_t         EcalExpDepoMuon[9];   //[nMuon]
   Float_t         HcalExpDepoMuon[9];   //[nMuon]
   Float_t         HoExpDepoMuon[9];   //[nMuon]
   Float_t         emS9Muon[9];   //[nMuon]
   Float_t         hadS9Muon[9];   //[nMuon]
   Float_t         hoS9Muon[9];   //[nMuon]
   Float_t         CaloCompMuon[9];   //[nMuon]
   Int_t           nPFTau;
   Int_t           pfJetIndexPFTau[114];   //[nPFTau]
   Int_t           isNonNullPFTau[114];   //[nPFTau]
   Int_t           chargePFTau[114];   //[nPFTau]
   Float_t         energyPFTau[114];   //[nPFTau]
   Float_t         etPFTau[114];   //[nPFTau]
   Float_t         momentumPFTau[114];   //[nPFTau]
   Float_t         thetaPFTau[114];   //[nPFTau]
   Float_t         etaPFTau[114];   //[nPFTau]
   Float_t         phiPFTau[114];   //[nPFTau]
   Float_t         pxPFTau[114];   //[nPFTau]
   Float_t         pyPFTau[114];   //[nPFTau]
   Float_t         pzPFTau[114];   //[nPFTau]
   Float_t         vertexXPFTau[114];   //[nPFTau]
   Float_t         vertexYPFTau[114];   //[nPFTau]
   Float_t         vertexZPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByLeadingTrackFindingPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByLeadingTrackPtCutPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByLeadingPionPtCutPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByIsolationPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByIsolationUsingLeadingPionPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByTrackIsolationPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByTrackIsolationUsingLeadingPionPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByECALIsolationPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByECALIsolationUsingLeadingPionPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrAgainstMuonPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrAgainstElectronPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByTaNCPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrHalfPercentPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrOnePercentPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrQuarterPercentPFTau[114];   //[nPFTau]
   Float_t         theTauDiscrByTaNCfrTenthPercentPFTau[114];   //[nPFTau]
   Float_t         isolationPFChargedHadrCandsPtSumPFTau[114];   //[nPFTau]
   Float_t         isolationPFGammaCandsEtSumPFTau[114];   //[nPFTau]
   Float_t         emFractionPFTau[114];   //[nPFTau]
   Float_t         hcalTotOverPLeadPFTau[114];   //[nPFTau]
   Float_t         hcal3x3OverPLeadPFTau[114];   //[nPFTau]
   Float_t         ecalStripSumEOverPLeadPFTau[114];   //[nPFTau]
   Float_t         bremsRecoveryEOverPLeadPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByLooseElectronRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByMediumElectronRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByTightElectronRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByLooseMuonRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByTightMuonRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByDecayModeFindingPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByVLooseIsolationPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByLooseIsolationPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByMediumIsolationPFTau[114];   //[nPFTau]
   Float_t         thehpsTauDiscrByTightIsolationPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByLeadingTrackFindingPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByLeadingTrackPtCutPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByLeadingPionPtCutPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTancPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTancRawPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTancVLoosePFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTancLoosePFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTancMediumPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTancTightPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByLooseElectronRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByMediumElectronRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTightElectronRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByLooseMuonRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTightMuonRejectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByDecayModeSelectionPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByVLooseIsolationPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByLooseIsolationPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByMediumIsolationPFTau[114];   //[nPFTau]
   Float_t         thehpsTancTausDiscrByTightIsolationPFTau[114];   //[nPFTau]
   Int_t           nReducedPFCand;
   Int_t           chargeReducedPFCand[7];   //[nReducedPFCand]
   Float_t         energyReducedPFCand[7];   //[nReducedPFCand]
   Float_t         thetaReducedPFCand[7];   //[nReducedPFCand]
   Float_t         etaReducedPFCand[7];   //[nReducedPFCand]
   Float_t         phiReducedPFCand[7];   //[nReducedPFCand]
   Float_t         pxReducedPFCand[7];   //[nReducedPFCand]
   Float_t         pyReducedPFCand[7];   //[nReducedPFCand]
   Float_t         pzReducedPFCand[7];   //[nReducedPFCand]
   Float_t         vertexXReducedPFCand[7];   //[nReducedPFCand]
   Float_t         vertexYReducedPFCand[7];   //[nReducedPFCand]
   Float_t         vertexZReducedPFCand[7];   //[nReducedPFCand]
   Int_t           nMet;
   ...
   Int_t           nAK5Jet;
   Int_t           chargeAK5Jet[102];   //[nAK5Jet]
   Float_t         energyAK5Jet[102];   //[nAK5Jet]
   Float_t         thetaAK5Jet[102];   //[nAK5Jet]
   Float_t         etaAK5Jet[102];   //[nAK5Jet]
   Float_t         phiAK5Jet[102];   //[nAK5Jet]
   Float_t         pxAK5Jet[102];   //[nAK5Jet]
   Float_t         pyAK5Jet[102];   //[nAK5Jet]
   Float_t         pzAK5Jet[102];   //[nAK5Jet]
   Float_t         vertexXAK5Jet[102];   //[nAK5Jet]
   Float_t         vertexYAK5Jet[102];   //[nAK5Jet]
   Float_t         vertexZAK5Jet[102];   //[nAK5Jet]
   Float_t         emFracAK5Jet[102];   //[nAK5Jet]
   Float_t         hadFracAK5Jet[102];   //[nAK5Jet]
   Float_t         areaAK5Jet[102];   //[nAK5Jet]
   Int_t           IdAK5Jet[102];   //[nAK5Jet]
   Int_t           nHitAK5Jet[102];   //[nAK5Jet]
   Int_t           nHit90AK5Jet[102];   //[nAK5Jet]
   Float_t         fHPDAK5Jet[102];   //[nAK5Jet]
   Float_t         covEtaEtaAK5Jet[102];   //[nAK5Jet]
   Float_t         covPhiPhiAK5Jet[102];   //[nAK5Jet]
   Float_t         fLSAK5Jet[102];   //[nAK5Jet]
   Float_t         fOOTAK5Jet[102];   //[nAK5Jet]
   Float_t         combinedSecondaryVertexBJetTagsAK5Jet[102];   //[nAK5Jet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5Jet[102];   //[nAK5Jet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5Jet[102];   //[nAK5Jet]
   Float_t         trackCountingHighPurBJetTagsAK5Jet[102];   //[nAK5Jet]
   Float_t         trackCountingHighEffBJetTagsAK5Jet[102];   //[nAK5Jet]
   Float_t         trackCountingVeryHighEffBJetTagsAK5Jet[102];   //[nAK5Jet]
   Float_t         uncorrEnergyAK5Jet[102];   //[nAK5Jet]
   Int_t           nAK5PFNoPUJet;
   Int_t           chargeAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         energyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         thetaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         etaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         phiAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         pxAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         pyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         pzAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         vertexXAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         vertexYAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         vertexZAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         chargedHadronEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         neutralHadronEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         photonEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         electronEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         muonEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         HFHadronEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         HFEMEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           chargedHadronMultiplicityAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           neutralHadronMultiplicityAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           photonMultiplicityAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           electronMultiplicityAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           muonMultiplicityAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           HFHadronMultiplicityAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           HFEMMultiplicityAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         areaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         weightedDz1AK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         weightedDz2AK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         betastarAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         rmsCandsHandAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         jetIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         nChargedIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         nNeutralsIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         dZIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         nParticlesIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         dR2MeanIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         dRMeanIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         frac01IdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         frac02IdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         frac03IdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         frac04IdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         frac05IdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         betaIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         betastarIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         betastarclassicIdMvaAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         chargedEmEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         neutralEmEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         combinedSecondaryVertexBJetTagsAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         trackCountingHighPurBJetTagsAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         trackCountingHighEffBJetTagsAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         trackCountingVeryHighEffBJetTagsAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         uncorrEnergyAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         rmsCandAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Float_t         ptDAK5PFNoPUJet[96];   //[nAK5PFNoPUJet]
   Int_t           nAK5PFPUcorrJet;
   Int_t           chargeAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         energyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         thetaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         etaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         phiAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         pxAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         pyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         pzAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         vertexXAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         vertexYAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         vertexZAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         chargedHadronEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         neutralHadronEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         photonEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         electronEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         muonEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         HFHadronEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         HFEMEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           chargedHadronMultiplicityAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           neutralHadronMultiplicityAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           photonMultiplicityAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           electronMultiplicityAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           muonMultiplicityAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           HFHadronMultiplicityAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           HFEMMultiplicityAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         areaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         weightedDz1AK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         weightedDz2AK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         betastarAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         rmsCandsHandAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         jetIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         nChargedIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         nNeutralsIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         dZIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         nParticlesIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         dR2MeanIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         dRMeanIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         frac01IdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         frac02IdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         frac03IdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         frac04IdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         frac05IdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         betaIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         betastarIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         betastarclassicIdMvaAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         chargedEmEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         neutralEmEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         combinedSecondaryVertexBJetTagsAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighEffBJetTagsAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         simpleSecondaryVertexHighPurBJetTagsAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighPurBJetTagsAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingHighEffBJetTagsAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         trackCountingVeryHighEffBJetTagsAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         uncorrEnergyAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         rmsCandAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Float_t         ptDAK5PFPUcorrJet[114];   //[nAK5PFPUcorrJet]
   Int_t           nAK5GenJet;
